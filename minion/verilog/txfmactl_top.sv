...
(
  ...
  // F2 Output
  output logic                                  ec_zero_f2a_h,
  output logic                                  eprod_hi_zero_f2a_h,
  output logic                                  eprod_lo_zero_f2a_h,
  ...
  output logic                                  trans_exp_fma2_exc_f2a_h,
  ...
  output logic                                  al2c3_neg_cin_ps_f3a_h,
  output logic                                  al1c3_neg_cin_f3a_h,
  // F4 Outputs
  ...
  output logic [TXFMA_RM_SZ-1:0]               rm_f5a_h,
  output                                        rc_rmm_f5a_h,
  output                                        rc_rup_f5a_h,
  output                                        rc_rne_f5a_h,
  output                                        rc_rdn_f5a_h,
